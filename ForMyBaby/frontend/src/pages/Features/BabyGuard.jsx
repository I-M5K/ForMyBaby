      ...
      <div className="babyguard-content">
        {selectedButton === 'button1' && (
          <div className="dashboard-content">
            ...
            <SleepStatusContent danger={danger} hours={hours} awake={awake} temp={temp} humid={humid} /> {/* 수정된 부분 */}
          </div>
        )}
        {selectedButton === 'button2' && <DetailContent danger={danger} hours={hours} awake={awake} />}
